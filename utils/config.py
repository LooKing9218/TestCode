...
class DefaultConfig(object):
    ...
    save_model_path = './Model_Saved_Adam_0304/Pretrained_{}_bs_64_LR_{}_train_un_TempSoftV1_FC1'.format(net_work,lr)
    log_dirs = './Logs_Adam_0304/Log_Pretrained_{}_loss_bs_64_LR_{}_train_un_TempSoftV1_FC1'.format(net_work,lr)
    # 预训练模型
    pretrained = False
